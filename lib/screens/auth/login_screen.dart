...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  final _emailController = TextEditingController(text: 'emilys'); // dummyjson default
  final _passwordController = TextEditingController(text: 'emilyspass'); // dummyjson default
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.task_alt, color: cs.onPrimaryContainer, size: 28),
