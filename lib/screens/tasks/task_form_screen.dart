...
class _TaskFormScreenState extends ConsumerState<TaskFormScreen> {
  ...
  Future<void> _save() async {
    ...
    bool success;
    if (isEditing) {
      success = await ref.read(tasksProvider.notifier).updateTask(widget.task!.id, data);
    } else {
    ...
    if (mounted) {
      ...
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(isEditing ? 'Task updated!' : 'Task created!'),
...
class _StatusSelector extends StatelessWidget {
  ...
  static const _statuses = [
    {'value': 'pending', 'label': 'Pending', 'icon': Icons.radio_button_unchecked, 'color': Colors.orange},
    {'value': 'in_progress', 'label': 'In Progress', 'icon': Icons.timelapse, 'color': Color(0xFF6C63FF)},
    {'value': 'completed', 'label': 'Completed', 'icon': Icons.check_circle, 'color': Colors.green},
  ];
          ...
          child: Padding(
            ...
            child: InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? color.withOpacity(0.1) : Theme.of(context).colorScheme.surfaceContainerHighest.withOpacity(0.3),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                ...
                child: Column(
                  children: [
                    Icon(s['icon'] as IconData, color: isSelected ? color : Theme.of(context).colorScheme.onSurfaceVariant, size: 22),
